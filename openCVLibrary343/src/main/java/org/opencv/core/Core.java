...
public class Core {
    ...
    //
    // C++:  void cv::mulSpectrums(Mat a, Mat background, Mat& c, int flags, bool conjB = false)
    //

    //javadoc: mulSpectrums(a, background, c, flags, conjB)
    ...
    //javadoc: mulSpectrums(a, background, c, flags)
